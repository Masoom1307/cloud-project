...
urlpatterns = [
    ...
    path('modules/register/<int:module_id>/', views.register_module, name='module-register'),
    path('modules/unregister/<int:module_id>/', views.unregister_module, name='module-unregister'),
    ...
    path('user/<int:pk>/', user_profile_view, name='user-profile'),
]
